  ...
  return (
    <>
      ...
      <main className="overflow-x-hidden">
          ...
          <div className="container relative z-20 mx-auto px-4 py-32 md:py-40">
            <div className="max-w-4xl mx-auto text-center">
              <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
                <div className="inline-flex items-center gap-2 bg-white dark:bg-gray-900/10 backdrop-blur-sm rounded-full px-4 py-2 mb-8 border border-white/20 dark:border-gray-700">
                  <Sparkles className="w-4 h-4 text-blue-600 dark:text-blue-400" />
                  <span className="text-sm text-gray-700 dark:text-gray-200 dark:text-gray-200 dark:text-gray-200">Next.js 16 + Premium SaaS Platform</span>
                </div>
              </motion.div>

              <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.1 }}
                className="text-5xl md:text-7xl lg:text-8xl font-bold text-gray-900 dark:text-white dark:text-white dark:text-white tracking-tight leading-tight">
                Build Faster with
              ...
              <motion.p initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }}
                className="mt-8 text-lg md:text-xl text-gray-600 dark:text-gray-300 dark:text-gray-300 dark:text-gray-300 max-w-2xl mx-auto">
              ...
              <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3 }}
                ...
                <Link href="/services" className="inline-flex items-center gap-2 bg-gray-100 dark:bg-white dark:bg-gray-900/10 hover:bg-gray-200 dark:hover:bg-white dark:bg-gray-900/20 text-gray-900 dark:text-white dark:text-white dark:text-white px-8 py-4 rounded-full text-lg font-medium transition-all">
        ...
        {/* STATS SECTION */}
        <section className="py-16 bg-white dark:bg-gray-900/60 dark:bg-gray-900/60 backdrop-blur-sm border-y dark:border-gray-800">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
              {[{ icon: Users, value: 1200, label: 'Happy Clients' },{ icon: FolderGit2, value: 500, label: 'Projects Delivered' },{ icon: Star, value: 4.9, label: 'Client Rating', isDecimal: true },{ icon: TrendingUp, value: 99, label: 'Uptime %' }].map((stat, i) => (
                <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: i * 0.1 }} viewport={{ once: true }}>
                  ...
                  <p className="text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400">{stat.label}</p>
                </motion.div>
              ))}
            </div>
          </div>
          ...
          <section className="py-20">
            <div className="container mx-auto px-4">
              <div className="text-center mb-8">
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 dark:text-gray-300 dark:text-gray-400">Drag or click to explore our latest work</p>
              </div>
              <CardStack
        ...
        {/* SERVICES SECTION */}
        {services.length > 0 && (
          <section className="py-20 bg-white dark:bg-gray-900/60 dark:bg-gray-900/60 backdrop-blur-sm">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12"><h2 className="text-4xl font-bold mb-4 dark:text-white">Our Services</h2><p className="text-xl text-gray-600 dark:text-gray-300 dark:text-gray-300 dark:text-gray-400">Comprehensive solutions for your business</p></div>
                  ...
                  <Link key={service.id || service._id} href={'/services/' + service.slug}>
                    <MagicCard gradientColor={theme === "dark" ? "#262626" : "#D9D9D955"} className="h-full">
                      <div className="p-6 text-center">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400 line-clamp-3">{service.description}</p>
        ...
        {testimonials.length > 0 && (
          <section className="py-20 overflow-hidden">
            <div className="container mx-auto px-4 mb-12">
              <div className="text-center"><h2 className="text-4xl font-bold mb-4 dark:text-white">What Our Clients Say</h2><p className="text-xl text-gray-600 dark:text-gray-300 dark:text-gray-300 dark:text-gray-400">Trusted by businesses worldwide</p></div>
            </div>
        ...
        {blogs.length > 0 && (
          <section className="py-20 bg-white dark:bg-gray-900/60 dark:bg-gray-900/60 backdrop-blur-sm">
            <div className="container mx-auto px-4">
              <div className="text-center mb-12"><h2 className="text-4xl font-bold mb-4 dark:text-white">Latest from Blog</h2><p className="text-xl text-gray-600 dark:text-gray-300 dark:text-gray-300 dark:text-gray-400">Insights, tutorials, and updates from our team</p></div>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  ...
                  <Link key={blog.id || blog._id} href={'/blog/' + blog.slug}>
                    <MagicCard gradientColor={theme === "dark" ? "#262626" : "#D9D9D955"} className="h-full">
                      <div className="p-6">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-400 dark:text-gray-400 line-clamp-2">{blog.excerpt}</p>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <CoolMode>
              <Link href="/contact" className="inline-flex items-center gap-2 bg-white dark:bg-gray-900 text-blue-600 px-8 py-4 rounded-xl text-lg font-medium hover:bg-gray-100 transition-all">Start Free Trial<ArrowRight className="w-5 h-5" /></Link>
            </CoolMode>
          </div>
        </section>
      </main>
