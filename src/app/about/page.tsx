    ...
    <>
      ...
      <main>
          ...
          <div className="container mx-auto px-4 max-w-4xl text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
              <div className="inline-flex items-center gap-2 bg-blue-100 rounded-full px-4 py-1.5 mb-4">
                ...
                <span className="text-sm text-blue-600 font-medium">Available for Projects</span>
              </div>
              ...
              <div className="flex flex-wrap gap-3 justify-center mt-4">
                <span className="inline-flex items-center gap-1 text-sm text-gray-500 bg-gray-100 px-3 py-1.5 rounded-full"><MapPin className="w-4 h-4" />India</span>
                <span className="inline-flex items-center gap-1 text-sm text-gray-500 bg-gray-100 px-3 py-1.5 rounded-full"><Briefcase className="w-4 h-4" />Full Stack Developer</span>
                <span className="inline-flex items-center gap-1 text-sm text-gray-500 bg-gray-100 px-3 py-1.5 rounded-full"><GraduationCap className="w-4 h-4" />B.Tech CSE</span>
              </div>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            <div className="bg-white rounded-3xl border p-8 md:p-10 shadow-xl">
          ...
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {defaultSkills.map((skill, i) => (
                <motion.div key={skill.name} initial={{ opacity: 0, scale: 0.8 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ delay: i * 0.05 }} viewport={{ once: true }} whileHover={{ y: -3 }} className="bg-white rounded-2xl border p-5 text-center hover:shadow-lg transition-all">
              ...
              <div className="space-y-8">
                {defaultExperiences.map((exp, i) => (
                  <motion.div key={i} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ delay: i * 0.15 }} viewport={{ once: true }} className="relative pl-14">
                    <div className={'absolute left-3.5 top-1 w-4 h-4 rounded-full border-2 ' + (exp.current ? 'bg-blue-600 border-blue-600' : 'bg-white border-gray-300')} />
                    <div className="bg-white rounded-2xl border p-6 hover:shadow-lg transition-all">
                      <div className="flex flex-wrap items-start justify-between gap-2 mb-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-xs text-gray-500 capitalize px-2 py-0.5 bg-gray-100 rounded-full">{exp.type}</span>
                        </div>
                      </div>
        ...
        <section className="py-16 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <div className="flex justify-center gap-4">
              <Link href="/contact" className="inline-flex items-center gap-2 bg-white text-blue-600 px-8 py-3 rounded-xl font-medium hover:bg-gray-100"><Mail className="w-5 h-5" />Get In Touch</Link>
              <button onClick={() => window.open('/resume.pdf', '_blank')} className="inline-flex items-center gap-2 border-2 border-white px-8 py-3 rounded-xl font-medium hover:bg-white/10"><Download className="w-5 h-5" />Download CV</button>
            </div>
          </div>
        </section>
      </main>
