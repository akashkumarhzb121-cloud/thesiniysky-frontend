...
function formatContent(text) {
  ...
  return text.split('\n').map((line, i) => {
    ...
    const boldText = trimmed.replace(/\*\*(.*?)\*\*/g, '<strong class="font-bold">C:\Users\akash\Desktop\thesiniysky-frontend\src\app\services\[slug]\page.tsx1</strong>');
