    ...
    <div className={cn("w-full", className)} onMouseEnter={() => setHovering(true)} onMouseLeave={() => setHovering(false)}>
      ...
      {showDots && (
        <div className="mt-6 flex items-center justify-center gap-3">
          ...
          {activeItem.href && (
            <Link href={activeItem.href} className="text-gray-500 hover:text-blue-600 dark:hover:text-blue-400 transition" aria-label="Open link">
    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-800 dark:to-gray-700 text-sm text-gray-400">
            No image
          </div>
        )}
      </div>
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        {item.tag && (
          <span className="text-xs font-medium text-blue-300 mb-1">{item.tag}</span>
        )}
